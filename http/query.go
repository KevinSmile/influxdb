...
func (r QueryRequest) Analyze(l query.LanguageService) (*QueryAnalysis, error) {
	switch r.Type {
	case "flux":
...
func (r QueryRequest) analyzeFluxQuery(l query.LanguageService) (*QueryAnalysis, error) {
	a := &QueryAnalysis{}
	pkg := l.Parse(r.Query)
